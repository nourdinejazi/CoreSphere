...
import { DataTableFacetedFilter } from "./retrait-data-table-facetfilter";
interface RetraitToolbarProps<TData> {
  table: Table<TData>;
  globalFilter: string;
  setGlobalFilter: (value: string) => void;
}

export function RetraitToolbar<TData>({
  table,
  globalFilter,
  setGlobalFilter,
}: RetraitToolbarProps<TData>) {
