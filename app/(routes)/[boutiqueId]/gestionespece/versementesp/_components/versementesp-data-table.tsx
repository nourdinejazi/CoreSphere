...
export function DataTable<TData, TValue>({
  ...
  const onDateChange = (newDateRange: DateRange | undefined) => {
    if (newDateRange?.from && newDateRange?.to) {
      table.getColumn("dateVersementEsp")?.setFilterValue(newDateRange);
    }
    if (!newDateRange?.from && !newDateRange?.to) {
      table.getColumn("dateVersementEsp")?.setFilterValue("");
    }
  };
    ...
    <div className=" pb-16 ">
      <div className="rounded-t-xl   bg-white pt-4 px-4 print:p-0 shadow-md">
        ...
        <div className="bg-[#E9EEF0] print:bg-white space-y-4 rounded-t-xl p-4  ">
          <h1 className="text-xl font-medium">Liste des Versements espéce</h1>
